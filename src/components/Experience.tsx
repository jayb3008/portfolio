...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      ref={sectionRef}
      className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-12 bg-gradient-to-b from-background to-secondary/5"
    >
                    ...
                    <div className="relative">
                      <CardHeader className="pb-3">
                        <div className="flex flex-wrap gap-2 items-baseline">
                          ...
                          <Badge
                            variant="secondary"
                            className="px-2 py-0.5 text-xs sm:text-sm font-medium bg-primary/10 text-primary"
                          >
                            {exp.type}
                          </Badge>
                        </div>
                        <div className="mt-2 space-y-1">
                          <div className="flex flex-wrap items-center gap-1.5 text-sm sm:text-base text-muted-foreground">
                          ...
                          <div className="flex items-center gap-1.5 text-sm sm:text-base text-primary/80">
                      ...
                      <CardContent className="space-y-4">
                        <div>
                          <h4 className="text-base sm:text-lg md:text-xl font-semibold mb-2 text-primary">
                            Key Achievements
                          </h4>
                          <ul className="space-y-1.5 text-sm sm:text-base text-muted-foreground">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {exp.skills.map((skill, idx) => (
                              <Badge
                                key={idx}
                                variant="outline"
                                className="px-2 py-0.5 text-xs sm:text-sm font-medium bg-primary/5 text-primary border-primary/20 hover:bg-primary/10 transition-colors"
                              >
                                {skill}
                              </Badge>
                            ))}
