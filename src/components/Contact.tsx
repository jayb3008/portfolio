...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (section && heading && intro && form && contactInfo) {
      gsap.fromTo(
        heading,
        { opacity: 0, y: 50 },
        {
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <div className="mb-6">
              <label
                className="block text-foreground/90 mb-2 text-sm font-medium"
                htmlFor="name"
              >
                Your Name
              </label>
              <input
                ...
                id="name"
                required
                className="w-full px-4 py-3 bg-foreground/5 border border-foreground/10 rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-4 py-3 bg-foreground/5 border border-foreground/10 rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 resize-none"
            ...
            <button
              ...
              className="w-full py-3 bg-accent hover:bg-accent/80 text-white font-medium rounded-lg transition-colors duration-300 disabled:opacity-70"
            >
          ...
          <div ref={contactInfoRef} className="flex flex-col justify-center">
            <div className="glass-morphism p-6 rounded-xl mb-6">
              <h3 className="text-xl font-bold mb-4 text-gradient-blue">
                Connect Information
              </h3>
            ...
            <div className="glass-morphism p-6 rounded-xl">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="w-12 h-12 rounded-full bg-foreground/5 hover:bg-accent/20 border border-foreground/10 flex items-center justify-center transition-colors"
                  aria-label="GitHub"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
