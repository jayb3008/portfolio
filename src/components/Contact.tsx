import React, { useRef, useEffect, FormEvent, useState, useCallback, useMemo, Suspense } from "react";
          ...
          <CardContent className="space-y-4 sm:space-y-6">
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-foreground/50 text-xs sm:text-sm text-left">Email</p>
                  <a
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-foreground/50 text-xs sm:text-sm text-left">Phone</p>
                  <a
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-foreground/50 text-xs sm:text-sm text-left">Location</p>
        ...
        >
          ...
          <CardContent>
            <div className="flex space-x-3 sm:space-x-4">
              <Suspense fallback={<div className="w-10 h-10 bg-gray-200 animate-pulse rounded-full" />}>
                <LazyMagnet
                  magnetStrength={6}
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <Card
            className="relative border-none bg-background/30 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.01]"
          >
            <SpotlightCard
              className="glass-morphism p-3 sm:p-4 md:p-6 rounded-lg flex-1"
              spotlightColor="rgba(0, 229, 255, 0.2)"
